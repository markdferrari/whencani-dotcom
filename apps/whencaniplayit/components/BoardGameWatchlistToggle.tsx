...
import { useBoardGameWatchlistActions, useBoardGameWatchlistIds } from '@/hooks/use-board-game-watchlist';

interface BoardGameWatchlistToggleProps {
  gameId: number;
  className?: string;
}

export function BoardGameWatchlistToggle({ gameId, className }: BoardGameWatchlistToggleProps) {
  const ids = useBoardGameWatchlistIds();
  const mutate = useBoardGameWatchlistActions();
