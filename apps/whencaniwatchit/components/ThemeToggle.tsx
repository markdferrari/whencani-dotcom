...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200/70 bg-white/90 transition hover:border-sky-500 hover:text-sky-500 dark:border-zinc-800/70 dark:bg-zinc-900/70 dark:text-zinc-100"
    >
